    ...
    <>
      ...
      <main className="max-w-[1180px] mx-auto px-5 py-6">
        ...
        <p className="text-ink-faint text-xs font-mono mb-6">
          Voli e treni in tempo reale nelle 4 province — fonte: Trieste Airport, ViaggiaTreno (Trenitalia/RFI)
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-line border border-line mb-8">
          ...
          <Panel title="Treni — stazioni capoluogo" linkLabel="ViaggiaTreno →" linkHref="http://www.viaggiatreno.it/" span={3}>
            <TreniPanel />
          </Panel>
        </div>
      </main>
